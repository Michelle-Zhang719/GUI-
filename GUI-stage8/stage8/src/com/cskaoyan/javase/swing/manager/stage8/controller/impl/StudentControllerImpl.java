package com.cskaoyan.javase.swing.manager.stage8.controller.impl;

import com.cskaoyan.javase.swing.manager.stage8.controller.StudentController;
import com.cskaoyan.javase.swing.manager.stage8.dao.StudentDao;
import com.cskaoyan.javase.swing.manager.stage8.dao.impl.StudentDaoImpl;
...
public class StudentControllerImpl implements StudentController {
    ...
    /**
     * 通过学号去数据源查找一条学生信息,存在就返回二维数组的表格数据,不存在就返回null
     * 注意: 学号是唯一的,所以查询到的学生必然是一条数据
     * @since 20:35
     * @param stuId 查询使用的学号
     * @return java.lang.String[][]
     * @author wuguidong@cskaoyan.onaliyun.com
    ...
    /**
     * 通过name去数据源查找学生信息,存在就返回二维数组的表格数据,不存在就返回null
     * 注意: 姓名不是唯一的,所以从数据源查出来的可能不只是一条数据,需要用数组存放
     *
     * @since 12:10
     * @param name 检索条件
     * @return java.lang.String[][]
    ...
    /**
     * 通过id直接修改一条学生信息,true表示修改成功,否者为失败
     * 方法返回一个int状态值表示结果:
     *     -1: 表示系统错误
     *      0: 表示成功修改
     *      1: 表示数据完全一致,禁止修改
